...
public class BookController {
    ...
    public String updateBook(@RequestBody Book book,HttpServletRequest request) throws  Exception{
        String dataPrix = "";
        String data = "";
        String dirPath = "";
        String imgurl="";
        ...
        System.out.println("这里是图片名称字符串："+imgurl);
        book.setImgurl(imgurl);
        int bookId=bookService.updateBook(book);
        System.out.println(book);
        return String.valueOf(bookId);
    ...
    public String delBook(@RequestBody Book book){
        int i=bookService.delBook(book);
    ...
    @RequestMapping("/findBooksByUser")
    public  List<Book> findBooksByUser(@RequestBody int userId){
